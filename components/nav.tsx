              ...
              <>
                ...
                <div className="hidden dark:flex">
                  <button
                    ...
                    className="active:scale-95 transition-transform flex w-12 h-12 rounded-full items-center justify-center hover:bg-primary/5 hover:dark:bg-primary-dark/5 outline-link text-white"
                  >
                    {lightIcon}
                  </button>
                </div>
