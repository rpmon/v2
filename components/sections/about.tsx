      ...
      <div className="inner grid grid-cols-[3fr_2fr] gap-[50px] md:block">
        <div className="styled-text text-blue-400 dark:text-teal-600">
          ...
          <p>
            ...
            where I focused on designing and developing scalable
            state-of-the-art solutions for an AI proctored Interview Platform on
            both the frontend and backend.
          </p>
          <p>
            I also post on my{" "}
            <Link href="https://blog.rohitprakash.dev" passHref={true}>
              <a
                target="_blank"
